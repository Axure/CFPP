...
/*!
 * @header      CFPP-Localization.h
 * @copyright   (c) 2014 - Jean-David Gadina - www.xs-labs.com / www.digidna.net
 * @abstract    CoreFoundation++ wrapper for localization functions
 */

#ifndef CFPP_LOCALIZATION_H
#define CFPP_LOCALIZATION_H
